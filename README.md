...
- `openapi/dify-all-workflows.openapi.json` is the canonical 2.0.0 document. It contains the ten workflow request schemas in the same `oneOf` request body, ordered for UI development.
